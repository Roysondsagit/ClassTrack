            ...
            <div className="animate-slide-up">
                ...
                <div style={{ maxWidth: 480 }}>
                    <div className="card" style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                        <div style={{ width: 80, height: 80, borderRadius: '50%', background: 'linear-gradient(135deg, var(--yellow), #ffaa00)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2rem', fontWeight: 800, color: '#000', margin: '0 auto 1rem', boxShadow: 'var(--shadow-yellow)' }}>
                            {initials}
                        </div>
                    ...
                    <div className="card">
                        ...
                        <form onSubmit={handleSave}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-input" value={profile?.role || 'user'} disabled style={{ opacity: 0.5, cursor: 'not-allowed', textTransform: 'capitalize' }} />
                            </div>
